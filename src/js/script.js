    ...
    //TO SHOW!!
         let fishIntervals = []; // Stock tous les intervals pour les poissons
         let moveInterval;
    ...
    */
    ...
    function setPos(item) {
        ...
        let topPos = Math.floor(Math.random() * ((clickZone.offsetHeight/5*4)-200)+(clickZone.offsetHeight/10));
      ...
      /*      if (randomNum%2 === 0)
        ...
        */
        ...
        et -5px pour la droite vers la gauche. */
            ...
            //right side
           // else {      
                    leftPos = Math.floor(Math.random() * ((clickZone.offsetWidth/2)-100)+(clickZone.offsetWidth/2));
        ...
        function endGame() {
            ...
            fishIntervals = [];
            document.querySelector('#final-score').innerText = "Votre score est : " + currentScore;
            // Affiche le popup
            document.querySelector('#endgame-popup').style.display = 'flex';
            document.querySelectorAll('#click-zone .fish').forEach(fish => fish.remove());
        }
